...
class AprobarOT extends StatefulWidget {
  const AprobarOT({Key? key, required this.id, required this.onChanged}) : super(key: key);

  final String id;
  final ValueChanged<int>? onChanged;

  @override
  _AprobarOTState createState() => _AprobarOTState();
}

class _AprobarOTState extends State<AprobarOT> {
            ...
            child: Padding(
              ...
              child: Column(
                children: [
                  ...
                  Text(
                    '¿Está seguro que desea Aprobar esta Obligación Tributaria?',
                    ...
                    children: [
                      ...
                      InkWell(
                        onTap: () async {
                          ...
                          final res = await _api.aprobarObligacionTributaria(widget.id);
                          if (res == 1) {
                            widget.onChanged!(1);
                            Navigator.pop(context);
                            showToast2('Obligación Tributaria Aprobada', Colors.green);
                          } else {
