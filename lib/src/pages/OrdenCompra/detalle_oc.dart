                      ...
                      cards(
                        child: Column(
                          ...
                          children: [
                            ...
                            rows(titulo: 'CC:', data: orden.ccOC ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Cliente:', data: orden.nombreEmpresa ?? '', st: 11, sd: 12),
                            SizedBox(
                      ...
                      cards(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: ScreenUtil().setHeight(6)),
                            rows(titulo: 'RUC:', data: orden.rucEmpresa ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Dirección:', data: orden.direccionEmpresa ?? '', st: 11, sd: 12),
                            SizedBox(
                              height: ScreenUtil().setHeight(6),
                            ),
                          ],
                      ...
                      cards(
                        child: Column(
                          ...
                          children: [
                            ...
                            SizedBox(height: ScreenUtil().setHeight(6)),
                            rows(titulo: 'RUC:', data: orden.rucProveedor ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Proforma:', data: orden.proformaOC ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Dirección:', data: orden.direccionProveedor ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Teléfono:', data: orden.telefonoProveedor ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Cond. Pago:', data: orden.condicionPagoOC ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Descuento:', data: orden.descuentoOC ?? '', st: 11, sd: 12),
                            Divider(),
                            rows(titulo: 'Contacto:', data: orden.contactoProveedor ?? '', st: 11, sd: 12),
                            SizedBox(height: ScreenUtil().setHeight(4)),
                            rows(titulo: 'Correo:', data: orden.emailProveedor ?? '', st: 11, sd: 12),
                            SizedBox(
                              height: ScreenUtil().setHeight(6),
                            ),
                          ],
            ...
            Expanded(
              child: Column(
                children: [
                  ...
                  SizedBox(height: ScreenUtil().setHeight(4)),
                  rows(titulo: 'U.M.:', data: recurso.umRecurso ?? '', st: 9, sd: 10),
                  rows(titulo: 'Cantidad:', data: recurso.cantidadDetalleOC ?? '', st: 9, sd: 10),
                  rows(
                      titulo: 'Precio Unit.:',
                      data:
